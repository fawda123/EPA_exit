...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in unit.pmax(pA\$widths[2:3], pB\$widths[2:3]): could not find function "{}unit.pmax"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'maxWidth' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'maxWidth' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'maxWidth' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in unit.pmax(pC\$widths[2:3], pD\$widths[2:3], pE\$widths[2:3]): could not find function "{}unit.pmax"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'maxWidth' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'maxWidth' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in textGrob(ylab, rot = 90): could not find function "{}textGrob"{}}}\end{kframe}
\end{knitrout}
